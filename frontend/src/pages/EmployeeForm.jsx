        ...
        <form onSubmit={handleSubmit} className="bg-[#F9FAFB] p-4 rounded">
          <div className="flex flex-col mb-4">
            ...
            <input
              type="email"
              id="email"
              className={`py-2 px-4 rounded-lg ${!valid.email.isValid && "border-red-400"}`}
          ...
          <div className="flex flex-col mb-4">
            ...
            <input
              type="text"
              id="name"
              className={`py-2 px-4 rounded-lg ${!valid.name.isValid && "border-red-400"}`}
          ...
          <div className="flex flex-col mb-4">
            ...
            <input
              type="date"
              id="joinDate"
              className={`py-2 px-4 rounded-lg ${!valid.joinDate.isValid && "border-red-400"}`}
              name="joinDate"
